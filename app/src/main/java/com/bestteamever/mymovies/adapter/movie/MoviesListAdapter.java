...
public class MoviesListAdapter
    extends AbstractRecyclerAdapter<MovieModel, MoviesListAdapter.ViewHolder> {

  public MoviesListAdapter(Context context, List<MovieModel> items) {
    super(context, items);
  }

  @Override public MoviesListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    return new ViewHolder(new MovieViewItem(super.getContext()));
  }

  @Override public void onBindViewHolder(MoviesListAdapter.ViewHolder holder, int position) {
